...
!function (t, e) {
            ...
            return t.next = function () {
                ...
                if (this._touchSupported) {
                    var n = function (t) {
                        ...
                        e._pointerEvent && at[t.originalEvent.pointerType.toUpperCase()] && (e.touchDeltaX = t.originalEvent.clientX - e.touchStartX), e._handleSwipe(), "hover" === e._config.pause && (e.pause(), e.touchTimeout && clearTimeout(e.touchTimeout), e.touchTimeout = setTimeout(function (t) {
                            return e.cycle(t)
                    ...
                    if (c._clearMenus(), !e) {
                        ...
                        if (g(t).trigger(i), !i.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var o = this._element;
                                "parent" === this._config.reference ? o = t : _.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && g(t).addClass(Ft), this._popper = new u(o, this._menu, this._getPopperConfig())
                            }
    ...
    var Ee = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], ye = {
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function (t, e) {
            ...
            o.forEach(function (t) {
                !function (t, e) {
                    ...
                    if (-1 !== e.indexOf(n)) return -1 === Ee.indexOf(n) || Boolean(t.nodeValue.match(Ce) || t.nodeValue.match(Te));
    ...
    var be = "tooltip", Ie = "bs.tooltip", De = "." + Ie, we = g.fn[be], Ae = "bs-tooltip",
        ...
        Qe = "manual", Be = function () {
            ...
            return t.enable = function () {
                ...
                function e() {
                    n._hoverState !== je && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), g(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), t && t()
                }

                var n = this, i = this.getTipElement(), o = g.Event(this.constructor.Event.HIDE);
                if (g(this.element).trigger(o), !o.isDefaultPrevented()) {
                    if (g(i).removeClass(Fe), "ontouchstart" in document.documentElement && g(document.body).children().off("mouseover", null, g.noop), this._activeTrigger[Ke] = !1, this._activeTrigger[Me] = !1, this._activeTrigger[qe] = !1, g(this.tip).hasClass(xe)) {
    ...
    var an = "scrollspy", ln = "bs.scrollspy", cn = "." + ln, hn = g.fn[an],
        ...
        En = ".nav-item", yn = ".list-group-item", Cn = ".dropdown", Tn = ".dropdown-item", Sn = ".dropdown-toggle",
        bn = "offset", In = "position", Dn = function () {
            function n(t, e) {
                var n = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + vn + "," + this._config.target + " " + yn + "," + this._config.target + " " + Tn, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, g(this._scrollElement).on(dn.SCROLL, function (t) {
                    return n._process(t)
            ...
            return t.refresh = function () {
                ...
                n.hasClass(gn) ? (n.closest(Cn).find(Sn).addClass(_n), n.addClass(_n)) : (n.addClass(_n), n.parents(pn).prev(vn + ", " + yn).addClass(_n), n.parents(pn).prev(En).children(vn).addClass(_n)), g(this._scrollElement).trigger(dn.ACTIVATE, {relatedTarget: e})
            }, t._clear = function () {
    ...
    var wn = "bs.tab", An = "." + wn, Nn = g.fn.tab, On = {
        ...
        Mn = "> .dropdown-menu .active", Kn = function () {
            ...
            return t.show = function () {
                ...
                var o = this, r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? g(e).children(Fn) : g(e).find(Un))[0],
                    s = n && r && g(r).hasClass(jn);
                if (r && s) {
                    var a = _.getTransitionDurationFromElement(r);
                    g(r).removeClass(Hn).one(_.TRANSITION_END, i).emulateTransitionEnd(a)
                } else i()
    ...
    }(), t.Alert = p, t.Button = P, t.Carousel = lt, t.Collapse = bt, t.Dropdown = Jt, t.Modal = ve, t.Popover = sn, t.Scrollspy = Dn, t.Tab = Kn, t.Toast = ni, t.Tooltip = Be, t.Util = _, Object.defineProperty(t, "__esModule", {value: !0})
});
